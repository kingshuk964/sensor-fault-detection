...
class ModelPusher:
    ...
    def __init__(self, model_pusher_artifact:ModelPusherConfig,model_eval_artifact:ModelEvaluationArtifact):
    ...
    def initiate_model_pusher(self)->ModelPusherArtifact:
        try:
            ...
            model_file_path = self.model_pusher_artifact.model_file_path
